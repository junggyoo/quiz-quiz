...
export const MOCK_QUIZ_HISTORY = [
  {
    type: 'multiple',
    difficulty: 'easy',
    category: 'Entertainment: Video Games',
    question: '테스트 질문 1',
    correctAnswer: 'Pro Skater',
    options: [
      'Pro Skater',
      'Underground',
      'American Wasteland',
  ...
  },
  {
    ...
    question: '테스트 질문 3',
    correctAnswer: 'Flowey',
    options: ['Toriel', 'Papyrus', 'Sans', 'Flowey'],
    userAnswer: 'Flowey',
    isCorrect: true,
  },
  {
    ...
    question: '테스트 질문 4',
    correctAnswer: 'Spy',
    options: ['Pyro', 'Spy', 'Engineer', 'Sniper'],
    userAnswer: 'Sniper',
    isCorrect: false,
  },
  {
